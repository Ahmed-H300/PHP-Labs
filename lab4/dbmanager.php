...
// var_dump($dbManager->getAllUsers());
// $data = array();
// $data["fname"] = 'H';
// $data["lname"] = 'F';
...
// $data["username"] = 'ahmed_hany';
// $data["password"] = 'bae5e3208a3c700e3db642b6631e95b9';
// $data["dep"] = 'OS';
// $data["room"] = 'application1';
// $data["image"] = 'images/1690132310.jpg';
// // test delUsr
// // var_dump($dbManager->delUser(11));
// // test insertUser
// // var_dump($dbManager->insertUser($data));
// // test update user
// // var_dump($dbManager->updateUser(12, $data));
// // test getuser
// var_dump($dbManager->getUser(12));
