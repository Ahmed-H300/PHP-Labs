...
if (isset($_GET["errors"])) {
    ...
    $data["username"] = $user[7];
    $data["password"] = $user[8];
    $data["dep"] = $user[9];
}
    ...
    <body>
        ...
        <main>
            <section>
                ...
                <form id="regform" <?php echo "action='saveedit.php?index=$index'" ?> method="post">
                    <fieldset>
                        ...
                        <fieldset>
                            ...
                            <input type="email" id="email" name="email" placeholder="Your email.." <?php if (isset($data["email"]) and !empty($data["email"])) echo "value=" . $data["email"] ?>>
